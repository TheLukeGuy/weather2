package weather2.client.render.foliage;
...
public class ParticleTallGrassTemp extends ParticleTexLeafColor {
    ...
    public ParticleTallGrassTemp(World worldIn, double posXIn, double posYIn, double posZIn, double mX, double mY, double mZ, TextureAtlasSprite par8Item) {
