...
*/
    ...
    public void nbtRead(NBTTagCompound par1nbtTagCompound) {
        ...
        if (par1nbtTagCompound.hasKey("coordsManagedLocationX"))
            coordsManagedLocation = CoroUtilNBT.readCoords("coordsManagedLocation", par1nbtTagCompound);
        if (par1nbtTagCompound.hasKey("coordsHomeX"))
            coordsHome = CoroUtilNBT.readCoords("coordsHome", par1nbtTagCompound);
    ...
    public void nbtWrite(NBTTagCompound par1nbtTagCompound) {
        ...
        if (coordsManagedLocation != null)
            CoroUtilNBT.writeCoords("coordsManagedLocation", coordsManagedLocation, par1nbtTagCompound);
