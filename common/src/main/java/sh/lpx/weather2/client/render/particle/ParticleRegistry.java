package sh.lpx.weather2.client.render.particle;

import sh.lpx.weather2.client.render.shader.MeshBufferManagerFoliage;
import sh.lpx.weather2.client.render.shader.MeshBufferManagerParticle;
