package sh.lpx.weather2.player;
...
public class PlayerData {
    ...
    public static void tryLoadPlayerNBT(String username) {
        ...
        try {
            String fileURL = WeatherUtilFile.getWorldSaveFolderPath() + WeatherUtilFile.getWorldFolderName() + File.separator + "sh/lpx/weather2" + File.separator + "PlayerData" + File.separator + username + ".dat";
