...
import sh.lpx.weather2.block.*;
import sh.lpx.weather2.config.ConfigMisc;
import sh.lpx.weather2.entity.EntityIceBall;
import sh.lpx.weather2.entity.EntityLightningBolt;
import sh.lpx.weather2.entity.EntityLightningBoltCustom;
import sh.lpx.weather2.entity.EntityMovingBlock;
import sh.lpx.weather2.item.ItemWeatherRecipe;
import weather2.block.*;
import sh.lpx.weather2.item.ItemPocketSand;
import sh.lpx.weather2.item.ItemSandLayer;
import sh.lpx.weather2.util.WeatherUtil;
...
public class CommonProxy implements IGuiHandler {
    ...
    public void postInit() {
        ...
        if (!ConfigMisc.Item_WeatherItemNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, weather_item), group,
        ...
        if (!ConfigMisc.Block_SensorNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, tornado_sensor), group,
        ...
        if (!ConfigMisc.Block_SirenNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, tornado_siren), group,
        ...
        if (!ConfigMisc.Block_SirenManualNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, tornado_siren_manual), group,
        ...
        if (!ConfigMisc.Block_WindVaneNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, wind_vane), group,
        ...
        if (!ConfigMisc.Block_AnemometerNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, anemometer), group,
        ...
        if (!ConfigMisc.Block_WeatherForecastNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, weather_forecast), group,
        ...
        if (!ConfigMisc.Block_WeatherMachineNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, weather_machine), group,
        ...
        if (!ConfigMisc.Block_WeatherDeflectorNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, weather_deflector), group,
        ...
        if (!ConfigMisc.Block_SandLayerNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, sand_layer), group,
                    new ItemStack(itemSandLayer, 64), new Object[]{"DDD", "DID", "DDD", 'D', Blocks.SAND, 'I', itemWeatherRecipe});
        if (!ConfigMisc.Block_SandNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, "sand"), group,
                    new ItemStack(Blocks.SAND, 1), new Object[]{"DDD", "D D", "DDD", 'D', itemSandLayer});

        if (!ConfigMisc.Item_PocketSandNoRecipe)
            GameRegistry.addShapedRecipe(new ResourceLocation(Weather.modID, pocket_sand), group,
